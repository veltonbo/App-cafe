...
html=html.split('\n').filter(line=>!line.includes('ui-professional.css')&&!line.includes('ui-premium.css')&&!line.includes('ui-professional.js')&&!line.includes('ui-shell.css')&&!line.includes('ui-shell.js')).join('\n');
...
console.log('Irrigação: visual premium v1 injetado.');
